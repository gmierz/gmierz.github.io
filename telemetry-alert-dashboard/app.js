...
function parseData(data) {
    ...
    alerts.forEach(alert => {
        ...
        if (alert.alertSummaryId == 1) {
            alert.additionalData = HARDCODED_CDF_363;
        }
    });
